...
regular_users = [
  { email: 'user1@example.com', bidding_fee_paid: true },
  { email: 'user2@example.com', bidding_fee_paid: true },
  { email: 'user3@example.com', bidding_fee_paid: false },
  { email: 'user4@example.com', bidding_fee_paid: true },
  { email: 'user5@example.com', bidding_fee_paid: false }
]
